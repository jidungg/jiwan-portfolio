...
title: 하우징(건축) 시스템
summary: 그리드 큐브맵 위에 블록을 배치하는 UGC 하우징 컨텐츠를 만들고, 그 건설 모드를 게임 맵 제작 툴로도 사용했습니다. 맵 json은 연속된 같은 블록을 (시작 인덱스, 반복 횟수)로 접어, 연속 블록 압축으로 맵 저장 객체 65% 감소, 건설 아이템 489종 자동 등록 했습니다.
