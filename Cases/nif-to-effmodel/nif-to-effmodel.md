...
summary: "메이플스토리2의 nif 이펙트를 FBX로 변환하니 메시만 멀쩡하고 텍스처링과 UV·알파 애니메이션이 깨졌습니다. nif 포맷 명세를 구할 방법이 없어, nif를 읽을 줄 아는 오픈소스 툴 NifSkope를 분석해 그 파싱 결과를 자체 포맷 .effmodel로 써내는 익스포터를 툴 안에 심었습니다. 컨트롤러 5종을 옮겨 이펙트 102개를 게임에 올렸습니다"
