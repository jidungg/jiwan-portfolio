---
id: nif-to-effmodel
title: 오픈 소스 프로그램 분석해서 nif → .effmodel 익스포터 심기
summary: "메이플스토리2의 nif 이펙트를 제 프로젝트에 맞게 변환해야 했습니다. nif 포맷 명세를 구할 방법이 없어, nif를 읽을 줄 아는 오픈소스 툴 NifSkope를 분석해 그 파싱 결과를 자체 포맷 .effmodel로 써내는 익스포터를 툴 안에 심었습니다. 컨트롤러 5종을 옮겨 이펙트 102개를 게임에 올렸습니다"
...
아래 이미지는 실제 프로젝트의 이펙트를 캡처한 이미지입니다.

![이펙트1 - 매직 클로](magicclaw-effect.png)
![이펙트2 - 텔레포트](teleport-effect.png)
